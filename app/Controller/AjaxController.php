...
class AjaxController extends AppController {
  ...
  public $helpers = array(
    ...
    'Number', 'Text', 'App', 'Inmuebles');

  public $uses = array('Propietario', 'Demandante', 'Inmueble', 'Evento', 'TipoChalet', 'TipoGaraje', 'TipoOficina',
	   'TipoPiso', 'TipoTerreno', 'Poblacion', 'Provincia', 'Zona', 'Ciudad', 'TipoContrato', 'EstadoInmueble');
	...
	public function getPoblacionesProvincia($provincia_id) {
		...
		$pob_array = $this->Poblacion->find('all', array(
			'order' => 'Poblacion.description ASC',	'conditions' => array('provincia_id' => $provincia_id)
		));
	...
	public function getZonasPoblacion($provincia_id, $poblacion_id) {
		...
		$zonas_array = $this->Zona->find('all', array(
				'order' => 'Zona.description ASC',	'conditions' => array('provincia_id' => $provincia_id, 'poblacion_id' => $poblacion_id)
		));
	...
	public function getCiudadesPoblacion($provincia_id, $poblacion_id) {
		...
		$ciudades_array = $this->Ciudad->find('all', array(
				'order' => 'Ciudad.description ASC',	'conditions' => array('provincia_id' => $provincia_id, 'poblacion_id' => $poblacion_id)
		));
