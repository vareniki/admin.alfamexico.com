...
class HerramientasController extends AppController {
	...
	public $uses = array('Inmueble', 'Demandante', 'TipoPiso', 'TipoLocal', 'TipoChalet', 'TipoOficina', 'TipoGaraje', 'TipoTerreno', 'TipoNave', 'TipoOtro');
	...
	public function lst_inmuebles() {
		...
		$_serialize = 'data';
		$_header = array('Referencia', 'Tipo', 'Subtipo', 'Precio venta', 'Precio alquiler', 'Dirección', 'Zona', 'M Construidos',
			'Habitaciones',	'Baños',	'Parking', 'Año de construcción',	'Estado de conservación',	'Interior/exterior',
			'Ascensor',	'Propietario', 'móvil',	'Agente',	'Estado',	'Fecha de captación',
			'Fecha de baja', 'Tipo de encargo',	'Honorarios', 'Oficina', 'Llaves', 'Portales');
	...
	public function lst_demandantes() {
		...
		$_serialize = 'data';
		$_header = array('Referencia', 'Demandante', 'Móvil', 'Agente', 'Tipo', 'Subtipo',
			'Operación', 'Precio minimo', 'Habitaciones min', 'Baños Min', 'Parking', 'Ascensor', 'Zona');
