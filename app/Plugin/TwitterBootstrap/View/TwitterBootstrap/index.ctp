	...
	<div class="row">
		<div class="span4">
			...
			<p>
				...
				<?php echo $this->Html->link('Settings', '#', array('class' => 'btn btn-sm', 'icon' => 'cog')); ?>
				<?php echo $this->Html->link('More Info', '#', array('class' => 'btn btn-sm btn-info', 'icon' => 'info-sign white')); ?>
			</p>
		</div>
		<div class="span4">
