		...
		<div class="col-xs-12 col-sm-8">
			...
			<ul>
				...
				if ($info['Inmueble']['es_alquiler'] == 't') {
					$this->Model->printIfExists($info, 'precio_alquiler', array('label' => 'Precio de renta', 'format' => 'currency'));
				}
...
<div class="text-right">
	...
	echo $this->Html->link('Hoja de visita', 'hojaVisita/' . $info['Inmueble']['id'], array('escape' => false, 'class' => 'btn btn-default btn-sm')) . "\n";
