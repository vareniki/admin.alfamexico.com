<?php
echo $this->Form->hidden('Piso.id');
echo $this->Form->hidden('Piso.inmueble_id');
echo $this->App->horizontalRadio('Piso.tipo_piso_id', '<span>[*]</span> Tipo de piso:', $tiposPiso, array('required' => 'true'));
?>
...
<!-- Gastos de comunidad -->
<?php
echo $this->App->horizontalInput('Piso.gastos_comunidad', 'Gastos de comunidad:', array('type' => 'number', 'div' => false, 'min' => 5, 'max' => 100000));
echo "<hr>";
