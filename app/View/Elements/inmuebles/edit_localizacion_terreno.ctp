...
<div class="oculto selec_punto_1">
  <?php echo $this->App->horizontalInput('Terreno.numero', 'Número:', array('type' => 'number', 'maxlength' => '10')); ?>
</div>
<div class="oculto selec_punto_2">
  <?php echo $this->App->horizontalInput('Terreno.kilometro', 'Kilómetro:', array('type' => 'number', 'maxlength' => '10')); ?>
</div>
<?php
