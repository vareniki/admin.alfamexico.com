<?php
echo $this->Form->hidden('Oficina.id');
echo $this->Form->hidden('Oficina.inmueble_id');
echo $this->App->horizontalRadio('Oficina.tipo_oficina_id', '<span>[*]</span> Tipo de oficina:', $tiposOficina, array('required' => 'true'));
?>
...
<!-- Gastos de comunidad -->
<?php
echo $this->App->horizontalInput('Oficina.gastos_comunidad', 'Gastos de comunidad:', array('type' => 'number', 'div' => false, 'min' => 5, 'max' => 100000));
