<?php
echo $this->App->horizontalInput('Piso.area_total_construida', 'M2 construidos (m&sup2;):', array('min' => 0, 'maxlength' => 5, 'labelClass' => 'obligat'));
echo $this->App->horizontalInput('Piso.area_total_util', 'M2 &uacute;tiles (m&sup2;):', array('min' => 0, 'maxlength' => 5));
?>
...
<?php
echo $this->App->horizontalInput('Piso.area_salon', 'Área salón (m&sup2;):', array('min' => 0, 'max' => 999, 'maxlength' => 3));
echo $this->App->horizontalInput('Piso.area_terraza', 'Área terraza (m&sup2;):', array('min' => 0, 'max' => 999, 'maxlength' => 3));
echo '<br>';
echo $this->App->horizontalInput('Piso.numero_habitaciones', 'Habitaciones:', array('min' => 0, 'max' => 50, 'maxlength' => 2, 'labelClass' => 'obligat'));
echo $this->App->horizontalInput('Piso.numero_armarios', 'Armarios empotrados:', array('min' => 0, 'max' => 20, 'maxlength' => 2));
echo $this->App->horizontalInput('Piso.numero_banos', 'Ba&ntilde;os:', array('min' => 0, 'max' => 20, 'maxlength' => 2, 'labelClass' => 'obligat'));
