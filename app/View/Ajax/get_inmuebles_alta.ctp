<table class='table'>
    ...
    <tbody>
        ...
        <tr<?php echo ( $item['Inmueble']['fecha_baja'] != null ) ? ' class="baja"' : '' ?>>
            ...
            <td><a class="bootbox-close-button" href='#'
                   data-info='<?php echo htmlspecialchars( json_encode( $item['Inmueble'] ), ENT_QUOTES ); ?>'><i
                            class="glyphicon glyphicon-hand-left"></i></a></td>
        </tr>
		<?php endforeach; ?>
    </tbody>
</table>